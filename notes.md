...

{
  ...
  "constraints": [
    ...
    "Μέρος Β:",
    "- type: 'grammar'",
    "- Υποστηρίζει προαιρετικά instructionB1 και instructionB2 στο ίδιο επίπεδο με τα questions.",
    "- Τα instructionB1 / instructionB2 είναι string.",
    "- Αν υπάρχουν παραδείγματα (π.χ. άνθρωπος → ο άνθρωπος), αυτά τοποθετούνται ΜΟΝΟ μέσα στο instructionB1 ως πολυγραμμικό string.",
