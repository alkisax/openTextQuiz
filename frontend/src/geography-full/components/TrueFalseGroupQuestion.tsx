...
import type { GeoTrueFalseGroupQuestion } from '../types/geographyFull.types'

type Props = {
  question: GeoTrueFalseGroupQuestion
  value?: Record<string, 'T' | 'F'>
  onChange: (value: Record<string, 'T' | 'F'>) => void
}

const TrueFalseGroupQuestion = ({
  question,
  value = {},
  onChange,
}: Props) => {
          ...
          <div key={statement.key} className='space-y-2 border p-3 rounded'>
            ...
            >
              <div className='flex items-center space-x-2'>
                ...
                <Label htmlFor={`${statement.key}_T`}>
                  Σ
                </Label>
              </div>
              ...
              <div className='flex items-center space-x-2'>
                ...
                <Label htmlFor={`${statement.key}_F`}>
                  Λ
                </Label>
              </div>
            </RadioGroup>
