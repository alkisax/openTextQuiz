            ...
            <CardContent className='space-y-4 text-sm text-muted-foreground'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate('/test-full', {
                      state: { geoCount: 1, cultCount: 0, histCount: 0, instCount: 0 },
                    })
                  }
                >
                  Ερωτήσεις Γεωγραφίας
                </Button>
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate('/test-full', {
                      state: { geoCount: 0, cultCount: 1, histCount: 0, instCount: 0 },
                    })
                  }
                >
                  Ερωτήσεις Πολιτισμού
                </Button>
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate('/test-full', {
                      state: { geoCount: 0, cultCount: 0, histCount: 1, instCount: 0 },
                    })
                  }
                >
                  Ερωτήσεις Ιστορίας
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate('/test-full', {
                      state: { geoCount: 0, cultCount: 0, histCount: 0, instCount: 1 },
                    })
                  }
                >
                  Ερωτήσεις Θεσμών
